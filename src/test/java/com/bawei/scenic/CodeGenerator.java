...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //数据库连接地址
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/day07?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        //驱动类 名称
        ...
        //包含那些表
        strategyConfig.setInclude("t_type","t_scenic","nation");
